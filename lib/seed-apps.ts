...
Nothing leaves your Mac. There is no main window and no account.`,
    ...
    iconUrl:
      "https://raw.githubusercontent.com/Derrick-Kello/Crest/HEAD/Crest/Assets.xcassets/AppIcon.appiconset/icon_512x512%402x.png",
    screenshots: [],
    ownerId: "",
...
**Activity.** A year of commits as a heatmap, plus a language breakdown by bytes with lockfiles excluded.`,
    ...
    homepage: "",
    iconUrl:
      "https://raw.githubusercontent.com/Derrick-Kello/workstation/HEAD/myworkstation/Assets.xcassets/AppIcon.appiconset/icon_512x512%402x.png",
    screenshots: [],
    ownerId: "",
    ownerName: "Smart Hive Labs",
    ownerAvatar: "https://avatars.githubusercontent.com/u/224883136?v=4",
